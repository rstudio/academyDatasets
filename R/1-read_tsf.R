# From https://github.com/rakshitha123/TSForecasting/blob/master/utils/data_loader.R
# Godahewa, Rakshitha and Bergmeir, Christoph and Webb, Geoffrey I. and Hyndman, Rob J. and Montero-Manso, Pablo.
# "Monash Time Series Forecasting Archive", 2021 (https://arxiv.org/abs/2105.06643).
...
read_tsf <- function(
  file, value_column_name = "series_value", key = NULL, index = NULL
) {
