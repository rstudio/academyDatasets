...
#'
#' @source <https://FAIRsharing.org>: IRD; Influenza Research Database; DOI: <https://doi.org/10.25504/FAIRsharing.ws7cgw>; Last edited: March 30, 2020, 1:15 p.m.; Last accessed: May 27 2021 4:25 p.m.
#'
#' @references
...
#' @family flu datasets
#'
#' @format `r rd_describe_format(flu, flu_dictionary)`
"flu"
